////////////////////////////////////////////////////////////
//Runs the checks for the Needs/Opportunity Responses Import Template
////////////////////////////////////////////////////////////

try {
    function needAndOpportunityResponsesCheck() {
        const responseTemplate = new NeedAndOpportunityResponsesCheck();
        const reportSheet =responseTemplate.createReportSheet();
